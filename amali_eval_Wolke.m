...
%iteration wird abgebrochen wenn Wert sich nichtmehr veraendert als daas
    ...
    for kk=1:NofFiles %Schleife ?ber alle Datens?tze
        ...
        for j=start:ende   %1:entries    %2000:5000  start:ende
            ...
            if tmp < BSR532mintrust  % noetig falls iter > itmax.
                ...
                disp('bsr at fit kann nicht bestimmt werden')
            end
            ...
            guteaeroposi= connrnge(H>  UeberlappEnde & H < hwo1 & Btemp532 < minimumBSR_cloudmask_ch532 & Btemp532S < minimumBSR_cloudmask_ch532 & Btemp355 < minimumBSR_cloudmask_ch355);
            ...
            if ~isempty(wowolke)% sonst ja sinnlos                
                ...
                %eignetlich sollte hier nichtmehr viel passieren
