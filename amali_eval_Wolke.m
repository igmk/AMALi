...
if isempty(files)
    ...
    for kk=1:NofFiles %Schleife ?ber alle Datens?tze
        ...
        for j=start:ende   %1:entries    %2000:5000  start:ende
            ...
            if tmp < BSR532Smintrust-diffisoll % noetig falls iter > itmax. %check -- logikfehler? diffi
            ...
            if BSR532Ssollarr(j) < BSR532Smintrust-diffisoll || ~isfinite(BSR532Ssollarr(j))
